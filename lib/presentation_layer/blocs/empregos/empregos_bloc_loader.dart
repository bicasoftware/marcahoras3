...
import 'package:marcahoras3/presentation_layer/blocs/empregos/empregos_arguments.dart';
...
class _EmpregosBlocLoaderState extends State<EmpregosBlocLoader> {
  ...
  Widget build(BuildContext context) {
    ...
    final empregoArgs = ModalRoute.of(context)?.settings.arguments as EmpregosArguments?;
